...
//     return result[0]?.generated_text || "Sorry, couldn't generate a recipe.";
//   } catch (err) {
//     console.error("Error in getRecipeFromGemini:", err.message);
...
// const hf = import.meta.env.VITE_HF_API_KEY;
